...
DropDownPicker.defaultProps = {
    ...
    showArrow: true,
    arrowSize: 15,
    customArrowUp: (size, color) => <AntDesign name="caretup" size={size} color={color} />,
    customArrowDown: (size, color) => <AntDesign name="caretdown" size={size} color={color} />,
    customTickIcon: () => <AntDesign name="check" size={15} />,
    zIndex: 5000,
    disabled: false,
    searchable: false,
